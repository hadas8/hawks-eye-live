...
export const viewBriefing = () => `<div class="stack">
  <div>
    ...
    <p class="lead">אתם קציני מודיעין ביחידת ניתוח 7 באמ"ן. הלילה שיירה של יחידה 4400 של חיזבאללה חוצה את ציר ההברחה מסוריה ללבנון, ובידינו כל הנתונים שצריך כדי לעצור אותה. הבעיה היא שאף אחד עוד לא הצליח לקרוא אותם.</p>
