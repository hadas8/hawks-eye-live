...
export const viewVault = () => `<div class="stack">
  <div>
    ...
    <h1>שש ספרות, סדר אחד</h1>
    <p class="lead">המטען שנתפס בשיירה סגור, והוא נפתח רק לצוות שאיתר אותו — בקוד שהרכבתם בעצמכם, מתחנה 1 עד תחנה 6.</p>
  </div>
  <form class="lockform" style="max-width:470px" data-submit="vault">
    <input type="text" id="vin" class="vin" dir="ltr" inputmode="numeric" maxlength="6"
